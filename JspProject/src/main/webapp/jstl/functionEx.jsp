...
<!-- str1에서 str1에 포함되어 있는 str2 이후의 문자열을 추출할 때 -->
substringAfter(str1, str2) : ${fn:substringAfter(str1, str2) }<br><br>

<!-- str1에서 str1에 포함되어 있는 str2 이전의 문자열을 추출할 때 -->
...
endsWidth(str1, str2) : ${fn:endsWith(str1, str2) }<br><br>
